...
public class FlatLists {
    ...
    public static <T> List<T> of(List<T> t0, List<T> t1) {
     ...
     * Unlike {@link ArrayList} or
     * {@link Arrays#asList(Object[])} there is
     ...
     * The elements may be null.
     *
     * <p>The list is created via {@link FlatLists#of(List)}.
     *
     * @param <T> Element type
     */
