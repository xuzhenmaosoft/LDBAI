...
public class StringIndexer extends SparkMLFeatureBase implements RealTimeTransformer {
    ...
    public Dataset select(Dataset<Row> transformedData) {
        return transformedData.select("CATEGORYINDEX");
    }

    @Override
    public String[] methods() {
        return new String[]{"string_indexer", "string_indexer_transformer"};
    }
